            ...
            <div className="justify-end gap-5 md:w-1/2">
                <ScrollReveal direction="left">
                    <form action="">
                        ...
                        <textarea
                            placeholder="Message*"
                            className="textarea textarea-lg textarea-ghost w-full rounded-none border-0 border-b-2 border-gray-600 bg-none focus:border-gray-600 focus:outline-none md:min-h-40"
                        ></textarea>
                        <Button className="btn mt-4 rounded-lg bg-sky-500 text-white hover:bg-sky-600" >
                        Send
                        </Button>
                    </form>
                </ScrollReveal>
