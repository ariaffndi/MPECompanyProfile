...
export default function Project() {
    ...
    const { search, sortOrder,  setSortField, toggleSort,  page, handlePageChange, handleSearch } =
        useFilterSortPagination('project.index', project.data, (projectItem) => projectItem.year.toString());
